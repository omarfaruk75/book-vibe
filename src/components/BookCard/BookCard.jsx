...
const BookCard = ({ book }) => {
    const { image, tags, bookName, author, category, rating, yearOfPublishing, totalPages, publisher } = book;
    return (
        ...
        <div className=" flex flex-row justify-center items-center rounded-xl mb-5">
            ...
            <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12 space-y-6">
                ...
                <div className="flex flex-row gap-8 text-base">
                    ...
                    <Link to={'./listedbook'} className="bg-[#23BE0A] px-3 py-1  text-lg rounded-full text-white font-medium"><button>View Details</button></Link>
                </div>
